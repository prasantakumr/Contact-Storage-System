...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CONTACT_DTLS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CONTACT_DTLS" 
   (	"NAME" VARCHAR2(20 BYTE), 
	"MOBILE_NO" NUMBER(10,0), 
	"NICK_NAME" VARCHAR2(20 BYTE), 
	"MAIL_ID" VARCHAR2(20 BYTE), 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CONTACT_DTLS_ADMIN
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CONTACT_DTLS_ADMIN" 
   (	"NAME" VARCHAR2(20 BYTE), 
	"MOBILE_NO" NUMBER(10,0), 
	"NICK_NAME" VARCHAR2(20 BYTE), 
	"MAIL_ID" VARCHAR2(20 BYTE), 
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.CONTACT_DTLS
SET DEFINE OFF;
Insert into SYSTEM.CONTACT_DTLS (NAME,MOBILE_NO,NICK_NAME,MAIL_ID,GENDER,D_O_B,NOTE) values ('Rohit',9876543210,'RB','rohit@gmil.com','Male',to_date('10-APR-91','DD-MON-RR'),'rohit@gmil.com');
Insert into SYSTEM.CONTACT_DTLS (NAME,MOBILE_NO,NICK_NAME,MAIL_ID,GENDER,D_O_B,NOTE) values ('Raj Pradhan',9871236540,'Raj','rajpradhan@gmail.com','Male',to_date('18-JUN-96','DD-MON-RR'),'rajpradhan@gmail.com');
Insert into SYSTEM.CONTACT_DTLS (NAME,MOBILE_NO,NICK_NAME,MAIL_ID,GENDER,D_O_B,NOTE) values ('Samira Seth',9874563210,'simi','samira@gmail.com','Female',to_date('12-JUN-96','DD-MON-RR'),'samira@gmail.com');
Insert into SYSTEM.CONTACT_DTLS (NAME,MOBILE_NO,NICK_NAME,MAIL_ID,GENDER,D_O_B,NOTE) values ('Srikant Panigrahy',9873216540,'vikey',null,'Male',to_date('20-MAR-96','DD-MON-RR'),null);
REM INSERTING into SYSTEM.CONTACT_DTLS_ADMIN
SET DEFINE OFF;
Insert into SYSTEM.CONTACT_DTLS_ADMIN (NAME,MOBILE_NO,NICK_NAME,MAIL_ID,GENDER,D_O_B,NOTE) values ('rrrrrrr',1212121212,'rr','asdfaf','Male',to_date('13-DEC-22','DD-MON-RR'),'afdsf');
...
SET DEFINE OFF;
Insert into SYSTEM.EMPLOYEES (EMP_ID,ENAME,DEPT,SALARY,ADDRESS) values ('e002','Prasanta','Developer',15000,'Ods');
Insert into SYSTEM.EMPLOYEES (EMP_ID,ENAME,DEPT,SALARY,ADDRESS) values ('e003','Srikant','Tester',20000,'Cut');
Insert into SYSTEM.EMPLOYEES (EMP_ID,ENAME,DEPT,SALARY,ADDRESS) values ('e001','Rohit','Developer',20000,'Bam');
...
REM INSERTING into SYSTEM.LOGIN_USER
SET DEFINE OFF;
Insert into SYSTEM.LOGIN_USER (NAME,MAIL_ID,MOBILE_NO,USER_NAME,PASSWORD,GENDER,ADDRESS) values ('aa','aa@asd',123,'asd','asd','Male','asd');
Insert into SYSTEM.LOGIN_USER (NAME,MAIL_ID,MOBILE_NO,USER_NAME,PASSWORD,GENDER,ADDRESS) values ('Prasanta','prasanta@gmail',9876543210,'Pras','Pras@123','Male','Berhampur');
...
SET DEFINE OFF;
Insert into SYSTEM.USERS (USER_NAME,PASSWORD,QUESTION,ANSWER) values ('admin','admin','admin','admin');
Insert into SYSTEM.USERS (USER_NAME,PASSWORD,QUESTION,ANSWER) values ('silpa','silpa','silpa','silpa');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."LOGIN_USER_PK" ON "SYSTEM"."LOGIN_USER" ("MAIL_ID", "USER_NAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index CONTACT_DTLS_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."CONTACT_DTLS_PK" ON "SYSTEM"."CONTACT_DTLS" ("MOBILE_NO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."EMPLOYEES_PK" ON "SYSTEM"."EMPLOYEES" ("EMP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOGIN_USER" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOGIN_USER" ADD CONSTRAINT "LOGIN_USER_PK" PRIMARY KEY ("MAIL_ID", "USER_NAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."LOGIN_USER" MODIFY ("USER_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOGIN_USER" MODIFY ("MAIL_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOGIN_USER" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USERS" MODIFY ("QUESTION" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."EMPLOYEES" ADD CONSTRAINT "EMPLOYEES_PK" PRIMARY KEY ("EMP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("ENAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."EMPLOYEES" MODIFY ("EMP_ID" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table CONTACT_DTLS_ADMIN
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONTACT_DTLS_ADMIN" MODIFY ("MOBILE_NO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONTACT_DTLS_ADMIN" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
--  Constraints for Table CONTACT_DTLS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CONTACT_DTLS" ADD CONSTRAINT "CONTACT_DTLS_PK" PRIMARY KEY ("MOBILE_NO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CONTACT_DTLS" MODIFY ("MOBILE_NO" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CONTACT_DTLS" MODIFY ("NAME" NOT NULL ENABLE);
--------------------------------------------------------
